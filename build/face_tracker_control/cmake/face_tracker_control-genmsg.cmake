...
set(MSG_I_FLAGS "-Iface_tracker_control:/home/lumos/robomaster_cv/RM-tutorial/cppprojects/face-gimbal/src/face_tracker_control/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/lumos/robomaster_cv/RM-tutorial/cppprojects/face-gimbal/src/face_tracker_control/msg/centroid.msg" NAME_WE)
add_custom_target(_face_tracker_control_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "face_tracker_control" "/home/lumos/robomaster_cv/RM-tutorial/cppprojects/face-gimbal/src/face_tracker_control/msg/centroid.msg" ""
)
...
_generate_msg_cpp(face_tracker_control
  "/home/lumos/robomaster_cv/RM-tutorial/cppprojects/face-gimbal/src/face_tracker_control/msg/centroid.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/face_tracker_control)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/face_tracker_control\")")
  # install generated code
  install(
